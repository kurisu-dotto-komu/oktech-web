    ...
    <div className="flex gap-5">
      <div>
        <span className="countdown font-mono text-4xl">
          <span
            style={{ "--value": timeLeft.days } as CSSProperties}
            aria-live="polite"
      ...
      <div>
        <span className="countdown font-mono text-4xl">
          <span
            style={{ "--value": timeLeft.hours } as CSSProperties}
            aria-live="polite"
      ...
      <div>
        <span className="countdown font-mono text-4xl">
          <span
            style={{ "--value": timeLeft.minutes } as CSSProperties}
            aria-live="polite"
      ...
      <div>
        <span className="countdown font-mono text-4xl">
          <span
            style={{ "--value": timeLeft.seconds } as CSSProperties}
            aria-live="polite"
